...
//2->trizteza
//3->alegria
void moverDeNodoANodo(int actual, int destino, int sentimiento, int velocidad)
{
    int proporcion;
    if(sentimiento ==1)
    {
...
{ 
  ...
  if(instruccion=='1'){
      moverDeNodoANodo(1,24,3,10);
    moverDeNodoANodo(24,25,3,10);
    moverDeNodoANodo(25,26,3,10);
     moverDeNodoANodo(26,25,3,10);
    moverDeNodoANodo(25,26,3,10);
    moverDeNodoANodo(26,25,3,10);
    moverDeNodoANodo(25,26,3,10);
    moverDeNodoANodo(26,25,3,10);
    ...
    moverDeNodoANodo(25,26,3,10);
    moverDeNodoANodo(26,25,3,10);
    moverDeNodoANodo(25,24,3,10);
    moverDeNodoANodo(24,1,3,10);    
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
  }
  else if(instruccion=='2'){
    moverDeNodoANodo(1,24,2,20);
    moverDeNodoANodo(24,25,2,20);
    moverDeNodoANodo(25,26,2,20);
     moverDeNodoANodo(26,25,2,20);
    moverDeNodoANodo(25,26,2,20);
    moverDeNodoANodo(26,25,2,20);
    moverDeNodoANodo(25,26,2,20);
    moverDeNodoANodo(26,25,2,20);
    ...
    moverDeNodoANodo(25,26,2,20);
    moverDeNodoANodo(26,25,2,20);
    moverDeNodoANodo(25,24,2,20);
    moverDeNodoANodo(24,1,2,20);    
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
  }
  else if(instruccion=='3'){
      moverDeNodoANodo(1,24,1,10);
    moverDeNodoANodo(24,25,1,5);
    moverDeNodoANodo(25,26,1,5);
     moverDeNodoANodo(26,25,1,5);
    moverDeNodoANodo(25,26,1,5);
    moverDeNodoANodo(26,25,1,5);
    moverDeNodoANodo(25,26,1,5);
    moverDeNodoANodo(26,25,1,5);
    ...
    moverDeNodoANodo(25,26,1,5);
    moverDeNodoANodo(26,25,1,5);
    moverDeNodoANodo(25,24,1,5);
    moverDeNodoANodo(24,1,1,10);    
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
        ...
        moverDeNodoANodo(1,12,3,10);
    moverDeNodoANodo(12,13,3,10);
    moverDeNodoANodo(13,13,3,10);
    moverDeNodoANodo(13,12,3,10);
    moverDeNodoANodo(12,14,3,10);
    moverDeNodoANodo(14,15,3,10);
    moverDeNodoANodo(15,15,3,10);
    moverDeNodoANodo(15,12,3,10);
    moverDeNodoANodo(12,16,3,10);
    moverDeNodoANodo(16,17,3,10);
    moverDeNodoANodo(17,17,3,10);
    moverDeNodoANodo(17,12,3,10);
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
  }
  else if(instruccion=='5'){
    moverDeNodoANodo(1,12,2,20);
    moverDeNodoANodo(12,13,2,20);
    moverDeNodoANodo(13,13,2,20);
    moverDeNodoANodo(13,12,2,20);
    moverDeNodoANodo(12,14,2,20);
    moverDeNodoANodo(14,15,2,20);
    moverDeNodoANodo(15,15,2,20);
    moverDeNodoANodo(15,12,2,20);
    moverDeNodoANodo(12,16,2,20);
    moverDeNodoANodo(16,17,2,20);
    moverDeNodoANodo(17,17,2,20);
    moverDeNodoANodo(17,12,2,20);   
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
  }
  else if(instruccion=='6'){
    moverDeNodoANodo(1,12,1,10);
    moverDeNodoANodo(12,13,1,5);
    moverDeNodoANodo(13,13,1,5);
    moverDeNodoANodo(13,12,1,5);
    moverDeNodoANodo(12,14,1,5);
    moverDeNodoANodo(14,15,1,5);
    moverDeNodoANodo(15,15,1,5);
    moverDeNodoANodo(15,12,1,5);
    moverDeNodoANodo(12,16,1,5);
    moverDeNodoANodo(16,17,1,5);
    moverDeNodoANodo(17,17,1,5);
    moverDeNodoANodo(17,12,1,10);   
    delay(1000);
    ledsCuerpoOff();
    delay(2000);
  }
